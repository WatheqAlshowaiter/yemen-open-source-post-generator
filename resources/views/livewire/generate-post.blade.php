<div class="mx-auto max-w-lg text-center bg:gray-500" >
    ...
    <form wire:submit="submit" class="mx-auto mt-8 mb-0 space-y-4">
        <div class="flex flex-col flex-1 justify-between items-center pt-5 pb-24 mx-auto w-full h-full" >
        ...
        <button wire:click="onPostCreated(4)" type="button" class="relative inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-600 focus:ring-3 focus:outline-hidden">
