<div class="mx-auto max-w-lg text-center bg:gray-500" >
    ...
    <form wire:submit="submit" class="mx-auto mt-8 mb-0 space-y-4">
        ...
        {{-- Generated Post --}}
        <h2 class="text-xl font-bold">Facebook / LinkedIn</h2>
        <div class="flex flex-col flex-1 justify-between items-center pb-4 mx-auto w-full h-full" >
        ...
        {{-- .Generated Tweet --}}
        <h2 class="text-xl font-bold">Twitter (X)</h2>
        <div class="flex flex-col flex-1 justify-between items-center  pb-4 mx-auto w-full h-full" >
            <div class="relative p-5 w-full h-auto rounded-lg border border-zinc-200 bg-zinc-50 prose prose-md">
                <textarea
                    dir="rtl"
                    wire:model="generated_tweet"
                    id="generated_tweet"
                    class="w-full rounded-lg border-gray-200 border-dashed p-4 pe-12 text-sm shadow-xs"
                    placeholder=""
                    rows="15"
                >{!! $response !!}</textarea>
                 ...
                 {{-- Alpine.js for Copy to Clipboard --}}
            <div x-data="{
                copyText: @entangle('generated_tweet'),
                copyNotification: false,
                copyToClipboard() {
                    navigator.clipboard.writeText(this.copyText);
                    this.copyNotification = true;
